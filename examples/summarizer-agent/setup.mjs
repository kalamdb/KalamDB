#!/usr/bin/env node
/**
 * Cross-platform setup for kalamdb-summarizer-agent.
 *
...
console.log('[setup] resetting topic blog.summarizer if it exists');
runKalam(['--command', 'DROP TOPIC blog.summarizer'], { allowFailure: true });
...
console.log('[setup] next: npm run start');
