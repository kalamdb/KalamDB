...
KALAMDB_OTLP_ENABLED="${KALAMDB_OTLP_ENABLED:-false}" \
KALAMDB_OTLP_ENDPOINT="${KALAMDB_OTLP_ENDPOINT:-http://127.0.0.1:4317}" \
KALAMDB_OTLP_PROTOCOL="${KALAMDB_OTLP_PROTOCOL:-grpc}" \
KALAMDB_OTLP_SERVICE_NAME="${KALAMDB_OTLP_SERVICE_NAME:-kalamdb-server}" \
