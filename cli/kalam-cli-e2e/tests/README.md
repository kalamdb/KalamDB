...
**Run with**: `cargo test -p kalam-cli-e2e --test usecases`
...
**Run with**: `cargo test -p kalam-cli-e2e --test users`
...
**Run with**: `cargo test -p kalam-cli-e2e --test auth`
...
**Run with**: `cargo test -p kalam-cli-e2e --test cli`
...
**Run with**: `cargo test -p kalam-cli-e2e --test subscription`
...
**Run with**: `cargo test -p kalam-cli-e2e --test tables`
...
**Run with**: `cargo test -p kalam-cli-e2e --test flushing`
...
**Run all smoke tests**: `cargo test -p kalam-cli-e2e --test smoke`
**Run specific category**: `cargo test -p kalam-cli-e2e --test smoke usecases`
...
**Run with**: `cargo test -p kalam-cli-e2e --test connection`

### 11. **cluster/** - Cluster Operations
Multi-node cluster functionality (future).
- Various cluster-related tests

**Run with**: `cargo test -p kalam-cli-e2e --test cluster`
...
**Run with**: `cargo nextest run -p kalam-cli-e2e --test performance --run-ignored ignored-only`
