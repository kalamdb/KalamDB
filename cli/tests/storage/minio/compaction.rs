...
use crate::common::{
    ...
    generate_unique_table, is_server_running, parse_job_id_from_json_message,
};
...
fn test_minio_storage_compact_table_command_runs() {
    ...
    let compact_output = execute_sql_as_root_via_client_json(&format!(
    ...
    let compact_status = wait_for_terminal_job_status(&compact_job_id, std::time::Duration::from_secs(30))
