...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3009: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3021: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1163: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1163_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1163_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1162: (a: number, b: number) => void;
