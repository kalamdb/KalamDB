...
Generated files land in `link/sdks/dart/link/lib/src/generated/` — commit them together with the
Rust changes.
...
| `link/sdks/dart/link/lib/src/generated/` | Auto-generated Dart bindings (do not edit manually) |
| `link/sdks/dart/link/lib/src/` | Hand-written Dart API layer (`kalam_client.dart`, `auth.dart`, `models.dart`) |
