    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_subscription_guard = api_subscription_guard.unwrap();
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::dart_live_events_id(&*api_subscription_guard))?;
                Ok(output_ok)
            })())
        },
    )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_subscription_guard = api_subscription_guard.unwrap();
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::dart_live_id(&*api_subscription_guard))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__dart_try_parse_file_ref_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::dart_try_parse_file_ref(api_file_ref_json))?;
                Ok(output_ok)
            })())
        },
    )
