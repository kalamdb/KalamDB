...
- test_access_level_is_rejected — [backend/tests/misc/sql/test_shared_access.rs](backend/tests/misc/sql/test_shared_access.rs)
- test_omitted_policy_is_dba_system_only — [backend/tests/misc/sql/test_shared_access.rs](backend/tests/misc/sql/test_shared_access.rs)
- test_select_policy_grants_user_reads_not_writes — [backend/tests/misc/sql/test_shared_access.rs](backend/tests/misc/sql/test_shared_access.rs)
